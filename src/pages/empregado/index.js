    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.addButton} onPress={() => setModalVisible(true)}>
          <Text style={[styles.addButtonText, { fontFamily: 'JetBrainsMono-Bold' }]}>
            + Cadastrar Empregado
          </Text>
        </TouchableOpacity>
      </View>
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={styles.empregadoContainer}>
            {item.imageUri && (
              <Image source={{ uri: item.imageUri }} style={styles.empregadoImage} />
            )}
            ...
            <View style={styles.buttonContainer}>
              <TouchableOpacity style={styles.editButton} onPress={() => handleEdit(item)}>
                <Text style={[styles.editButtonText, { fontFamily: 'JetBrainsMono-Bold' }]}>
                  Editar
                </Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.actionButton} onPress={() => handleDelete(item.id)}>
                <Text style={[styles.actionButtonText, { fontFamily: 'JetBrainsMono-Bold' }]}>
                  Excluir
                </Text>
              </TouchableOpacity>
            </View>
        ...
        <View style={styles.modalContainer}>
          <View style={[styles.modalContent, { fontFamily: 'JetBrainsMono-Bold' }]}>
            ...
            <TouchableOpacity style={styles.imagePickerButton} onPress={pickImage}>
              <Text style={[styles.imagePickerButtonText, { fontFamily: 'JetBrainsMono-Bold' }]}>
                Selecionar Imagem
              </Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity onPress={resetForm} style={styles.cancelButton}>
              <Text style={[styles.cancelButtonText, { fontFamily: 'JetBrainsMono-Bold' }]}>
                Cancelar
              </Text>
            </TouchableOpacity>
          </View>
